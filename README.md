...
Interactive OpenSSL cert generator — prompts for DN fields (including email), key size, digest, basicConstraints, and DNS/IP SANs, then generates a reusable config, CSR, and optionally a self-signed certificate from an existing private key.
